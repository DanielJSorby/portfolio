	...
	<div class="contact-content">
		<div class="contact-info">
			...
			<div class="info-item">
				...
				<a 
					href={settings?.location_url || "https://www.google.com/maps/place/Oslo"} 
					target="_blank" 
					rel="noopener noreferrer"
					class="location-link"
				>
					{settings?.location_text || "Oslo, Norge"}
				</a>
			</div>
			<div class="info-item">
				<span class="label">{t.contact.email}</span>
				<a href="mailto:{settings?.contact_email || 'kontakt@danielsorby.no'}">{settings?.contact_email || 'kontakt@danielsorby.no'}</a>
			</div>
